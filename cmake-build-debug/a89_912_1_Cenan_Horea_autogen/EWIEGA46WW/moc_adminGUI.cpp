...
QT_MOC_LITERAL(1, 9, 17), // "coatUpdatedSignal"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "adminGUI\0coatUpdatedSignal\0"
};
...
void adminGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->coatUpdatedSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&adminGUI::coatUpdatedSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void adminGUI::coatUpdatedSignal()
{
