...
QT_MOC_LITERAL(1, 8, 16), // "coatUpdateSignal"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16), // "endProgramSignal"
QT_MOC_LITERAL(4, 43, 14), // "endProgramSlot"
QT_MOC_LITERAL(5, 58, 11) // "displaySlot"

    },
    "userGUI\0coatUpdateSignal\0\0endProgramSignal\0"
    "endProgramSlot\0displaySlot"
};
...
void userGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->coatUpdateSignal(); break;
        case 1: _t->endProgramSignal(); break;
        case 2: _t->endProgramSlot(); break;
        case 3: _t->displaySlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&userGUI::coatUpdateSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (userGUI::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&userGUI::endProgramSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void userGUI::coatUpdateSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void userGUI::endProgramSignal()
{
